      ...
      <Card className="bg-[#0015ff] border-8 border-blue-600 shadow-none relative overflow-hidden" style={{
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="relative">
            <Input type="text" placeholder="BUNDESLAND" value={postcode} onChange={e => setPostcode(e.target.value)} required className="pr-12 h-14 text-center text-lg font-mono-digital bg-black border-2 border-white text-white placeholder:text-white/60 focus:shadow-[0_0_20px] focus:shadow-white/50 transition-all duration-300 rounded-none" />
